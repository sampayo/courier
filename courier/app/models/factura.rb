class Factura < ActiveRecord::Base
  ...
  def self.facturatotal(id)
      return Factura.find_by_sql('SELECT f.id, o.id as numOrden, o.notificacion, (f.costoTotal + f.iva) as monto, o.fecha from facturas f, ordens o where o.id=f.ordens_id and o.personas_id='+id.to_s)
  end
end
